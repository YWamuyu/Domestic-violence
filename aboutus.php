...
<!-- nav start -->
  <nav class="navbar navbar-expand-lg navbar-dark bg-danger">
    ...
    <!-- <a class="navbar-brand" href="#">Domestic Violence System</a> -->
...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
    ...
    <p class="lead"><h4>Who we are?</h4>
		...
		This is a body incharge of managing by providing solution and actions to domestic violence casing that are tremendously increasing.
    ...
    <p class="lead"><h4>What we are are doing?</h4>
		...
		Providing an interactive system that allows users to report an incident from any geographical location. We are using google map to locate the places of incidence.
