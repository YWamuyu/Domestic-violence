      ...
      <div class="container">
        <div class="card card-body">
          ...
          <div class="form-group">
            ...
            <input type="input" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="NIC Number" required>
          </div>

          <!-- User Name -->
          <div class="form-group">
            <label for="exampleInputEmail1">User Name</label>
            <input type="input" class="form-control" name="user_name" placeholder="User Name" required>
          </div>
          ...
          <div class="card card-body">
            ...
            <p>Address: <input type="text" class="search_addr" size="45" required></p><br>
            <p>Latitude: <input type="text" class="search_latitude" size="30" required></p><br>
            <p>Longitude: <input type="text" class="search_longitude" size="30" required></p><br>
            ...
            <div class="form-group">
              ...
              <input type="input" class="form-control" name="address" placeholder="Enter Address" required>
            </div>

            <!-- Latitude -->
            <div class="form-group">
              <label for="exampleInputEmail1">Latitude</label>
              <input type="input" class="form-control" name="latitude" placeholder="Enter Latitude" required>
            </div>

            <!-- Longitude -->
            <div class="form-group">
              <label for="exampleInputEmail1">Longitude</label>
              <input type="input" class="form-control" name="latitude" placeholder="Enter Longitude" required>
            </div>
        ...
        <option>Economic Abuse</option>
        <option>Sexual Abuse</option>
        <option>Psychological Abuse</option> 
      </select>
          </div>
