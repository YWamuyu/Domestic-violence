...
<!-- nav start -->
  <nav class="navbar navbar-expand-lg navbar-dark bg-danger">
    ...
    Domestic Violence
        ...
        <li class="nav-item">
			 			<a href="../chat/index.php"><button type="button" class="btn btn-dark my-2 my-sm-0">Chat Now!</button></a>
			 </li>
       &nbsp;
			 <li class="nav-item">
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <h5>Welcom To Department Of Domestic Violence</h5>
...
<div class="jumbotron">
  <h1 class="display-4">Welcome to Department Domestic Violence</h1>
